...
const DashboardBanner = ({ user }) => {
  return (
    <div className="flex rounded-lg flex-col  p-4 md:py-8 md:px-20 space-y-6 md:space-y-0 md:flex-row justify-around items-center bg-blue bg-[#c7e5ef] text-white">
